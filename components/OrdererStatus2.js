...
// export default class OrdererStatus2 extends Component {
//   render() {
//     return (
...
//         <Text style={styles.title}>Order was picked up</Text>
//         <Text style={styles.subtitle}>
//           Order was picked up by deliverer and is on it's way.
//         </Text>
...
function OrdererStatus2({navigation}) {
