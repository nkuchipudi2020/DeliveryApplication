...
// export default class DelivererStatus2 extends Component {
//   render() {
//     return (
//       <View style={{flex: 1, backgroundColor: '#FFFFFF'}}>
//         <Image
//           style={styles.image}
//           source={require('../assets/images/status2.png')}></Image>
//         <Text style={styles.title}>Deliver Order</Text>
//         <Text style={styles.subtitle}>
//           Deliver the order and confirm using the details and button below.
//         </Text>
...
//               onPress={() => this.props.navigation.navigate('Deliverer3')}>
//               <Text style={styles.titlesButton}>Delivered Order</Text>
//             </TouchableOpacity>
//           </View>
//         </View>
//       </View>
...
function DelivererStatus2({navigation}) {
  ...
  const updateAll = () => {
    orderList.forEach(order => {
      ...
      console.log(conNo);
      updateOrderStatus(conNo, 'delivered');
    });
    navigation.navigate('DelivererStatus3');
  };
...
export default DelivererStatus2;
