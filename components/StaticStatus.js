...
// export default class OrdererStatus3 extends Component {
//   render() {
//     return (
//       <View style={{flex: 1, backgroundColor: '#FFFFFF'}}>
//         <Image
//           style={styles.image}
//           source={require('../assets/images/status3.png')}></Image>
//         <Text style={styles.title}>Order deliverered</Text>
//         <Text style={styles.subtitle}>
//           Order was deliverered. Check outside the front door of your hall.
//         </Text>
...
//               <Text style={styles.titlesButton}>Done</Text>
//             </TouchableOpacity>
//           </View>
//         </View>
//       </View>
...
function StaticStatus({navigation}) {
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#FFFFFF'}}>
      <Image
        style={styles.image}
        source={require('../assets/images/status3.png')}
      />
      <Text style={styles.title}>Order will be delivered</Text>
      <Text style={styles.subtitle}>
        Your order will be here soon. Check outside your hall in 10 minutes. 
      </Text>
