...
// import {getOrderListbyOrderer, deleteOrder} from '../firebase/apiService';
...
// const data = () => {
//   getOrderListbyOrderer(user.id)
//     .then(result => {
//       result.forEach(documentSnapshot => {
//         alert(documentSnapshot);
//         flatListData.push(documentSnapshot);
//       });
//     })
//     .catch(error => {
//       console.log(error);
