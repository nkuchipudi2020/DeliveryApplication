...
// export default class DelivererStatus3 extends Component {
//   render() {
//     return (
...
//           Delivery is complete! You will receiive your pay in your bank account
//           soon.
//         </Text>
...
//               onPress={() => this.props.navigation.navigate('DelivererHome')}>
...
function DelivererStatus3({navigation}) {
  ...
  const updateAll = () => {
    orderList.forEach(order => {
      ...
      console.log(conNo);
      updateOrderStatus(conNo, 'completed');
    });
...
export default DelivererStatus3;
